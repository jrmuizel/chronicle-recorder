 ...
 * Source lines and columns are 1-based.
 * If a source line cannot be resolved, then filename will be NULL and
 * start_line and start_column will be 0.  If ending line and column
